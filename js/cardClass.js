class Card {
  constructor(card, cards, id, languages) {
    this.card = card;
    this.cards = cards;
    this.id = id;
   ...
   */
  static handleClick(cards, card, languages, id) {
    // Modal einblenden
    fadeModal("in");
   ...
   */
  static showEditMode(id, cards, card, languages) {
   ...
   *
   */
  static async deleteCard(cards, languages, id) {
    console.log(cards);
