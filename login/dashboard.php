...
?>
    <div id="snackbar"></div><div class="formWrapper">
        <form name="ProjectForm" class="form">
            ...
            <input onblur="this.checkValidity() && (this.style.outline='none')" id="ProjectImage" class="text textImage validity" type="file" id="img" name="img" accept="image/*" required />
